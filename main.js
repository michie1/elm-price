...
var _cuducos$elm_format_number$Helpers$splitThousands = function (num) {
	return (_elm_lang$core$Native_Utils.cmp(num, 1000) > -1) ? A2(
		_elm_lang$core$List$append,
		_cuducos$elm_format_number$Helpers$splitThousands((num / 1000) | 0),
		A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$core$Basics_ops['%'], num, 1000),
					_1: {ctor: '[]'}
				}))) : {
		ctor: '::',
		_0: _elm_lang$core$Basics$toString(num),
		_1: {ctor: '[]'}
	};
};
var _cuducos$elm_format_number$Helpers$decimals = F2(
	function (digits, num) {
		return A3(
			_elm_lang$core$String$padLeft,
			digits,
			...
			A2(
				...
				_elm_lang$core$String$concat(
					_cuducos$elm_format_number$Helpers$splitThousands(
...
var _cuducos$elm_format_number$FormatNumber$format = F2(
	function (locale, num) {
		var truncated = _elm_lang$core$Basics$truncate(num);
		var integers = function () {
			var _p0 = A2(_elm_lang$core$Basics$compare, truncated, 0);
			switch (_p0.ctor) {
				case 'GT':
					return A2(
						_elm_lang$core$String$join,
						locale.thousandSeparator,
						_cuducos$elm_format_number$Helpers$splitThousands(truncated));
				case 'EQ':
					return '0';
				default:
					return A2(
						...
						A2(
							...
							_elm_lang$core$Native_Utils.update(
								locale,
								{decimals: 0}),
							_elm_lang$core$Basics$toFloat(0 - truncated)));
			}
		}();
		return _elm_lang$core$Native_Utils.eq(locale.decimals, 0) ? integers : _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: integers,
				_1: {
					ctor: '::',
					_0: locale.decimalSeparator,
					_1: {
						ctor: '::',
						_0: A2(_cuducos$elm_format_number$Helpers$decimals, locale.decimals, num),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _ohanhi$keyboard_extra$Keyboard_Extra$downs = function (toMsg) {
	return _elm_lang$keyboard$Keyboard$downs(
		function (_p16) {
			return toMsg(
				_ohanhi$keyboard_extra$Keyboard_Extra$fromCode(_p16));
		});
};
var _ohanhi$keyboard_extra$Keyboard_Extra$ups = function (toMsg) {
	return _elm_lang$keyboard$Keyboard$ups(
		function (_p17) {
			return toMsg(
				_ohanhi$keyboard_extra$Keyboard_Extra$fromCode(_p17));
		});
};
var _ohanhi$keyboard_extra$Keyboard_Extra$updateWithKeyChange = F2(
	function (msg, _p18) {
		...
		if (_p20.ctor === 'Down') {
			var _p21 = _p20._0;
			var nextState = A2(_ohanhi$keyboard_extra$Keyboard_Extra$insert, _p21, _p23);
			var change = (!_elm_lang$core$Native_Utils.eq(
				_elm_lang$core$List$length(nextState),
				_elm_lang$core$List$length(_p23))) ? _elm_lang$core$Maybe$Just(
				_ohanhi$keyboard_extra$Keyboard_Extra$KeyDown(
					_ohanhi$keyboard_extra$Keyboard_Extra$fromCode(_p21))) : _elm_lang$core$Maybe$Nothing;
			return {
				ctor: '_Tuple2',
			...
			var _p22 = _p20._0;
			var nextState = A2(_ohanhi$keyboard_extra$Keyboard_Extra$remove, _p22, _p23);
			var change = (!_elm_lang$core$Native_Utils.eq(
				_elm_lang$core$List$length(nextState),
				_elm_lang$core$List$length(_p23))) ? _elm_lang$core$Maybe$Just(
				_ohanhi$keyboard_extra$Keyboard_Extra$KeyUp(
					_ohanhi$keyboard_extra$Keyboard_Extra$fromCode(_p22))) : _elm_lang$core$Maybe$Nothing;
			return {
				ctor: '_Tuple2',
				_0: _ohanhi$keyboard_extra$Keyboard_Extra$State(nextState),
				_1: change
...
var _ohanhi$keyboard_extra$Keyboard_Extra$pressedDown = function (_p24) {
	var _p25 = _p24;
	return A2(_elm_lang$core$List$map, _ohanhi$keyboard_extra$Keyboard_Extra$fromCode, _p25._0);
};
...
var _user$project$Main$onEnter = function (msg) {
	...
	var decoder = A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Debug$log, 'filterKey', filterKey),
			...
			case 'KeyboardExtraMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							keyboardState: A2(_ohanhi$keyboard_extra$Keyboard_Extra$update, _p0._0, model.keyboardState)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyUp':
				...
				if (model.focus) {
					var price = function () {
						if (_elm_lang$core$Native_Utils.eq(_p2, 46) || _elm_lang$core$Native_Utils.eq(_p2, 8)) {
							return (model.price / 10) | 0;
						} else {
							if (_elm_lang$core$Native_Utils.eq(_p2, 67)) {
								return 0;
							} else {
								var n = ((_elm_lang$core$Native_Utils.cmp(_p2, 48) > -1) && (_elm_lang$core$Native_Utils.cmp(_p2, 57) < 1)) ? _elm_lang$core$Maybe$Just(_p2 - 48) : (_elm_lang$core$Native_Utils.eq(_p2, 45) ? _elm_lang$core$Maybe$Just(0) : (_elm_lang$core$Native_Utils.eq(_p2, 35) ? _elm_lang$core$Maybe$Just(1) : (_elm_lang$core$Native_Utils.eq(_p2, 40) ? _elm_lang$core$Maybe$Just(2) : (_elm_lang$core$Native_Utils.eq(_p2, 34) ? _elm_lang$core$Maybe$Just(3) : (_elm_lang$core$Native_Utils.eq(_p2, 37) ? _elm_lang$core$Maybe$Just(4) : (_elm_lang$core$Native_Utils.eq(_p2, 12) ? _elm_lang$core$Maybe$Just(5) : (_elm_lang$core$Native_Utils.eq(_p2, 39) ? _elm_lang$core$Maybe$Just(6) : (_elm_lang$core$Native_Utils.eq(_p2, 36) ? _elm_lang$core$Maybe$Just(7) : (_elm_lang$core$Native_Utils.eq(_p2, 38) ? _elm_lang$core$Maybe$Just(8) : (_elm_lang$core$Native_Utils.eq(_p2, 33) ? _elm_lang$core$Maybe$Just(9) : _elm_lang$core$Maybe$Nothing))))))))));
								var _p1 = n;
								if (_p1.ctor === 'Nothing') {
									return model.price;
								} else {
									return (model.price * 10) + _p1._0;
								}
							}
						}
					}();
			...
			case 'OnClick':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							price: _user$project$Main$limitPrice((model.price * 10) + _p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Focus':
...
var _user$project$Main$OnInput = {ctor: 'OnInput'};
...
var _user$project$Main$view = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('inner'),
			_1: {
				ctor: '::',
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _user$project$Main$onEnter(_user$project$Main$OnInput),
											_1: {ctor: '[]'}
										}
									}
								},
